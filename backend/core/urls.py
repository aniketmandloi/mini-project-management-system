...
urlpatterns = [
    ...
    path('tasks/<int:task_pk>/comments/', views.TaskCommentListView.as_view(), name='task_comment_list'),
    path('comments/<int:pk>/', views.TaskCommentDetailView.as_view(), name='task_comment_detail'),
]