...
class ProjectAdmin(admin.ModelAdmin):
    ...
    """
    list_display = [
        'name', 'organization', 'status', 'task_count_display', 
        'completion_rate_display', 'due_date', 'created_at'
    ]
    list_filter = ['status', 'organization', 'created_at', 'due_date']
    search_fields = ['name', 'description', 'organization__name']
    readonly_fields = ['created_at', 'updated_at', 'task_count_display', 'completion_rate_display']
...
class TaskCommentAdmin(admin.ModelAdmin):
    ...
    """
    list_display = [
        'task', 'author_email', 'content_preview', 'created_at'
    ]
    list_filter = [
        'task__project__organization', 'task__project', 
        'task', 'created_at'
    ]
    search_fields = [
        'content', 'author_email', 'task__title', 
        'task__project__name'
    ]
    readonly_fields = ['created_at', 'updated_at']
