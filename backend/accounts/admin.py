...
class UserAdmin(BaseUserAdmin):
    ...
    """
    list_display = [
        'email', 'get_full_name', 'organization', 'is_organization_admin',
        'email_verified', 'is_active', 'created_at'
    ]
    list_filter = [
        'is_active', 'is_staff', 'is_superuser', 'is_organization_admin',
        'email_verified', 'organization', 'created_at'
    ]
...
class UserSessionAdmin(admin.ModelAdmin):
    ...
    def deactivate_sessions(self, request, queryset):
        ...
        self.message_user(
            request,
            f'{updated} session(s) were successfully deactivated.'
        )
...
class EmailVerificationTokenAdmin(admin.ModelAdmin):
    ...
    """
    list_display = [
        'user', 'email', 'token_short', 'is_valid_display',
