...
# Security Settings
SECRET_KEY = config('SECRET_KEY', default='fn4xj=!6_!a=x@h@u#z&q0d*uv5nj_8trxs##6!qfn2ho@jkh$')
...
JWT_REFRESH_TOKEN_LIFETIME = config('JWT_REFRESH_TOKEN_LIFETIME', default=86400, cast=int)  # 24 hours
